...
class PixtralProcessor(ProcessorMixin):
    ...
    tokenizer_class = ...
    def __init__(self, image_processor=..., tokenizer=..., patch_size: int = ..., chat_template=..., image_token=..., image_break_token=..., image_end_token=..., **kwargs) -> None:
        ...
    
    def __call__(self, images: ImageInput = ..., text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., audio=..., videos=..., **kwargs: Unpack[PixtralProcessorKwargs]) -> BatchMixFeature:
        """
