...
class MllamaVisionConfig(PretrainedConfig):
    ...
    ```"""
    model_type = ...
    def __init__(self, hidden_size: int = ..., hidden_act: str = ..., num_hidden_layers: int = ..., num_global_layers: int = ..., num_attention_heads: int = ..., num_channels: int = ..., intermediate_size: int = ..., vision_output_dim: int = ..., image_size: int = ..., patch_size: int = ..., norm_eps: float = ..., max_num_tiles: int = ..., intermediate_layers_indices: Optional[List[int]] = ..., supported_aspect_ratios: Optional[List[List[int]]] = ..., initializer_range: float = ..., **kwargs) -> None:
        ...
...
class MllamaTextConfig(PretrainedConfig):
    ...
    ```"""
    model_type = ...
    def __init__(self, vocab_size: int = ..., hidden_size: int = ..., hidden_act: str = ..., num_hidden_layers: int = ..., num_attention_heads: int = ..., num_key_value_heads: int = ..., intermediate_size: int = ..., rope_theta: float = ..., rope_scaling: Optional[Dict] = ..., rms_norm_eps: float = ..., max_position_embeddings: int = ..., initializer_range: float = ..., use_cache: bool = ..., tie_word_embeddings: bool = ..., cross_attention_layers: Optional[List[int]] = ..., dropout: float = ..., bos_token_id: int = ..., eos_token_id: int = ..., pad_token_id: Optional[int] = ..., **kwargs) -> None:
        ...
