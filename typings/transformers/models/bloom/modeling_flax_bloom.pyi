...
class FlaxBloomBlockCollection(nn.Module):
    ...
    def __call__(self, hidden_states, alibi, attention_mask=..., deterministic: bool = ..., init_cache: bool = ..., output_attentions: bool = ..., output_hidden_states: bool = ...): # -> tuple[Any, tuple[()] | tuple[Any, ...] | None, tuple[()] | tuple[Any, ...] | None]:
        ...
