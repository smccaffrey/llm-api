...
class Pix2StructVisionAttention(nn.Module):
    ...
    def forward(self, hidden_states, attention_mask=..., position_bias=..., layer_head_mask=..., output_attentions=...): # -> tuple[Any, Any | Tensor, Any | Tensor] | tuple[Any, Any | Tensor]:
        """
...
class Pix2StructTextAttention(nn.Module):
    def __init__(self, config: Pix2StructTextConfig, has_relative_attention_bias=..., layer_idx: Optional[int] = ...) -> None:
        ...
