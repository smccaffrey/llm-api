...
class Swin2SRImageProcessor(BaseImageProcessor):
    ...
    def preprocess(self, images: ImageInput, do_rescale: Optional[bool] = ..., rescale_factor: Optional[float] = ..., do_pad: Optional[bool] = ..., pad_size: Optional[int] = ..., return_tensors: Optional[Union[str, TensorType]] = ..., data_format: Union[str, ChannelDimension] = ..., input_data_format: Optional[Union[str, ChannelDimension]] = ...): # -> BatchFeature:
        """
