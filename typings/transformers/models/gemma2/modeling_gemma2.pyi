...
class Gemma2ForCausalLM(Gemma2PreTrainedModel, GenerationMixin):
    ...
    def prepare_inputs_for_generation(self, input_ids, past_key_values=..., attention_mask=..., inputs_embeds=..., cache_position=..., position_ids=..., use_cache=..., num_logits_to_keep=..., **kwargs): # -> dict[str, Any]:
        ...
