...
class TFLxmertEncoder(keras.layers.Layer):
    ...
    def call(self, lang_feats=..., lang_attention_mask=..., visual_feats=..., visual_pos=..., visual_attention_mask=..., output_attentions=..., training=...): # -> tuple[tuple[tuple[()] | tuple[Any, ...], tuple[()] | tuple[Any] | None], tuple[tuple[()] | tuple[Any, ...], tuple[()] | tuple[Any] | None], tuple[()] | tuple[Any] | None]:
        ...
