...
class LxmertEncoder(nn.Module):
    ...
    def forward(self, lang_feats, lang_attention_mask, visual_feats, visual_pos, visual_attention_mask=..., output_attentions=...): # -> tuple[tuple[tuple[()] | tuple[Any, ...], tuple[()] | tuple[Any] | None], tuple[tuple[()] | tuple[Any, ...], tuple[()] | tuple[Any] | None], tuple[()] | tuple[Any] | None]:
        ...
