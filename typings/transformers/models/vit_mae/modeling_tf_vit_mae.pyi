...
class TFViTMAEEmbeddings(keras.layers.Layer):
    ...
    def call(self, pixel_values: tf.Tensor, noise: tf.Tensor = ..., interpolate_pos_encoding: bool = ...) -> tf.Tensor:
        ...
...
class TFViTMAEPatchEmbeddings(keras.layers.Layer):
    ...
    def call(self, pixel_values: tf.Tensor, training: bool = ..., interpolate_pos_encoding: bool = ...) -> tf.Tensor:
        ...
...
class TFViTMAEMainLayer(keras.layers.Layer):
    ...
    @unpack_inputs
    def call(self, pixel_values: TFModelInputType | None = ..., noise: tf.Tensor = ..., head_mask: np.ndarray | tf.Tensor | None = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., training: bool = ..., interpolate_pos_encoding: bool = ...) -> Union[TFViTMAEModelOutput, Tuple[tf.Tensor]]:
        ...
...
class TFViTMAEDecoder(keras.layers.Layer):
    ...
    def call(self, hidden_states, ids_restore, output_attentions=..., output_hidden_states=..., return_dict=..., interpolate_pos_encoding=...): # -> tuple[Any, ...] | TFViTMAEDecoderOutput:
        ...
...
class TFViTMAEForPreTraining(TFViTMAEPreTrainedModel):
    ...
    def call(self, pixel_values: TFModelInputType | None = ..., noise: tf.Tensor = ..., head_mask: np.ndarray | tf.Tensor | None = ..., output_attentions: Optional[bool] = ..., output_hidden_states: Optional[bool] = ..., return_dict: Optional[bool] = ..., training: bool = ..., interpolate_pos_encoding: bool = ...) -> Union[TFViTMAEForPreTrainingOutput, Tuple[tf.Tensor]]:
        r"""
        Returns:
