...
from ...utils import TensorType, filter_out_non_signature_kwargs, is_tf_available, is_torch_available, is_torchvision_available
...
class SamImageProcessor(BaseImageProcessor):
    ...
    def preprocess(self, images: ImageInput, segmentation_maps: Optional[ImageInput] = ..., do_resize: Optional[bool] = ..., size: Optional[Dict[str, int]] = ..., mask_size: Optional[Dict[str, int]] = ..., resample: Optional[PILImageResampling] = ..., do_rescale: Optional[bool] = ..., rescale_factor: Optional[Union[int, float]] = ..., do_normalize: Optional[bool] = ..., image_mean: Optional[Union[float, List[float]]] = ..., image_std: Optional[Union[float, List[float]]] = ..., do_pad: Optional[bool] = ..., pad_size: Optional[Dict[str, int]] = ..., mask_pad_size: Optional[Dict[str, int]] = ..., do_convert_rgb: Optional[bool] = ..., return_tensors: Optional[Union[str, TensorType]] = ..., data_format: ChannelDimension = ..., input_data_format: Optional[Union[str, ChannelDimension]] = ...): # -> BatchFeature:
        """
