...
class PerceiverTrainablePositionEncoding(PerceiverAbstractPositionEncoding):
    ...
    def forward(self, batch_size: int, interpolate_pos_encoding: bool = ..., input_size: torch.Size = ...) -> torch.Tensor:
        ...
...
class PerceiverTextPreprocessor(AbstractPreprocessor):
    ...
    def forward(self, inputs: torch.LongTensor, pos: Optional[torch.Tensor] = ..., network_input_is_1d: bool = ..., interpolate_pos_encoding: bool = ...): # -> tuple[Any, None, Any]:
        ...
...
class PerceiverImagePreprocessor(AbstractPreprocessor):
    ...
    def forward(self, inputs: torch.Tensor, pos: Optional[torch.Tensor] = ..., network_input_is_1d: bool = ..., interpolate_pos_encoding: bool = ...): # -> tuple[Tensor, None, Tensor]:
        ...
...
class PerceiverAudioPreprocessor(AbstractPreprocessor):
    ...
    def forward(self, inputs: torch.Tensor, pos: Optional[torch.Tensor] = ..., network_input_is_1d: bool = ..., interpolate_pos_encoding: bool = ...): # -> tuple[Tensor | Any, None, Any]:
        ...
...
class PerceiverMultimodalPreprocessor(AbstractPreprocessor):
    ...
    def forward(self, inputs: Mapping[str, torch.Tensor], pos: Optional[torch.Tensor] = ..., network_input_is_1d: bool = ..., interpolate_pos_encoding: bool = ...) -> PreprocessorOutputType:
        ...
