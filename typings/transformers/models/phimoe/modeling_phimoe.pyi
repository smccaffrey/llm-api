...
@add_start_docstrings("The bare Phimoe Model outputting raw hidden-states without any specific head on top.", PHIMOE_START_DOCSTRING)
...
class PhimoeForCausalLM(PhimoePreTrainedModel, GenerationMixin):
    ...
    def prepare_inputs_for_generation(self, input_ids, past_key_values=..., attention_mask=..., inputs_embeds=..., cache_position=..., position_ids=..., use_cache=..., num_logits_to_keep=..., **kwargs): # -> dict[Any, Any]:
        ...
