...
class LlavaOnevisionProcessor(ProcessorMixin):
    ...
    def __init__(self, image_processor=..., tokenizer=..., video_processor=..., num_image_tokens=..., vision_feature_select_strategy=..., chat_template=..., image_token=..., video_token=..., **kwargs) -> None:
        ...
    
    def __call__(self, images: ImageInput = ..., text: Union[TextInput, PreTokenizedInput, List[TextInput], List[PreTokenizedInput]] = ..., audio=..., videos: VideoInput = ..., **kwargs: Unpack[LlavaOnevisionProcessorKwargs]) -> BatchFeature:
        """
    ...
    @classmethod
    def from_pretrained(cls, pretrained_model_name_or_path, **kwargs): # -> Self | LlavaOnevisionProcessor:
        ...
