...
class Blip2Config(PretrainedConfig):
    ...
    ```"""
    model_type = ...
    def __init__(self, vision_config=..., qformer_config=..., text_config=..., num_query_tokens=..., image_text_hidden_size=..., image_token_index=..., **kwargs) -> None:
        ...
    
    @classmethod
    def from_vision_qformer_text_configs(cls, vision_config: Blip2VisionConfig, qformer_config: Blip2QFormerConfig, text_config: Optional[PretrainedConfig] = ..., **kwargs): # -> Self:
        r"""
