...
class LlavaForConditionalGeneration(LlavaPreTrainedModel, GenerationMixin):
    ...
    def get_image_features(self, pixel_values: torch.FloatTensor, vision_feature_layer: int, vision_feature_select_strategy: str): # -> Any:
        """
