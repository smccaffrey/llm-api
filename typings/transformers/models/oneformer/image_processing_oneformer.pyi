...
class OneFormerImageProcessor(BaseImageProcessor):
    ...
    def preprocess(self, images: ImageInput, task_inputs: Optional[List[str]] = ..., segmentation_maps: Optional[ImageInput] = ..., instance_id_to_semantic_id: Optional[Dict[int, int]] = ..., do_resize: Optional[bool] = ..., size: Optional[Dict[str, int]] = ..., resample: PILImageResampling = ..., do_rescale: Optional[bool] = ..., rescale_factor: Optional[float] = ..., do_normalize: Optional[bool] = ..., image_mean: Optional[Union[float, List[float]]] = ..., image_std: Optional[Union[float, List[float]]] = ..., ignore_index: Optional[int] = ..., do_reduce_labels: Optional[bool] = ..., return_tensors: Optional[Union[str, TensorType]] = ..., data_format: Union[str, ChannelDimension] = ..., input_data_format: Optional[Union[str, ChannelDimension]] = ...) -> BatchFeature:
        ...
