...
class DPTImageProcessor(BaseImageProcessor):
    ...
    def post_process_depth_estimation(self, outputs: DepthEstimatorOutput, target_sizes: Optional[Union[TensorType, List[Tuple[int, int]], None]] = ...) -> List[Dict[str, TensorType]]:
        """
