...
from ...utils import TensorType, filter_out_non_signature_kwargs, is_scipy_available, is_torch_available, is_vision_available
...
class Owlv2ImageProcessor(BaseImageProcessor):
    ...
    def preprocess(self, images: ImageInput, do_pad: bool = ..., do_resize: bool = ..., size: Dict[str, int] = ..., do_rescale: bool = ..., rescale_factor: float = ..., do_normalize: bool = ..., image_mean: Optional[Union[float, List[float]]] = ..., image_std: Optional[Union[float, List[float]]] = ..., return_tensors: Optional[Union[str, TensorType]] = ..., data_format: ChannelDimension = ..., input_data_format: Optional[Union[str, ChannelDimension]] = ...) -> PIL.Image.Image:
        """
