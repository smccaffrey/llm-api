...
class GLPNImageProcessor(BaseImageProcessor):
    ...
    def preprocess(self, images: Union[PIL.Image.Image, TensorType, List[PIL.Image.Image], List[TensorType]], do_resize: Optional[bool] = ..., size_divisor: Optional[int] = ..., resample=..., do_rescale: Optional[bool] = ..., return_tensors: Optional[Union[TensorType, str]] = ..., data_format: ChannelDimension = ..., input_data_format: Optional[Union[str, ChannelDimension]] = ...) -> BatchFeature:
        """
