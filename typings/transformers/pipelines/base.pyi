...
def infer_framework_load_model(model, config: AutoConfig, model_classes: Optional[Dict[str, Tuple[type]]] = ..., task: Optional[str] = ..., framework: Optional[str] = ..., **model_kwargs): # -> tuple[str | Any, Any]:
    """
...
def infer_framework_from_model(model, model_classes: Optional[Dict[str, Tuple[type]]] = ..., task: Optional[str] = ..., framework: Optional[str] = ..., **model_kwargs): # -> tuple[str | Any, Any]:
    """
    Select framework (TensorFlow or PyTorch) to use from the `model` passed. Returns a tuple (framework, model).
